# метод для валидации передаваемого значения на nil
# метод для валидации передаваемого значения на передаваемую длину
# метод для валидации передаваемого значения на передаваемый регексп
# метод возврата статуса валидации
